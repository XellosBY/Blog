<?if(isset($postSearched)):?>
<?foreach ($postSearched as $post):?>
	<div class="post">
		...
		<div class="entry">
			...
			<?if($post->photo != 0):?>
				...
				<?/*endforeach;*/?>
			<?endif;?>
			<p align='right'><a href="<?=URL::site("account/edit/$post->id")?>">Редактировать пост!</a></p>
			<p align='right'><a href="<?=URL::site("account/delete/$post->id")?>">Удалить пост!</a></p>
